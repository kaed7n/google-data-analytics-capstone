  ...
  kept_columns <- c("hospital_pk", "collection_week","geocoded_hospital_address", "hospital_name","total_beds_7_day_avg", "all_adult_hospital_inpatient_beds_7_day_avg", "all_adult_hospital_inpatient_bed_occupied_7_day_avg", "staffed_adult_icu_bed_occupancy_7_day_avg", "previous_day_total_ED_visits_7_day_sum")
  ...
  rgn_cidade_data <- rgn_cidade_data %>%
    mutate(all_adult_hospital_inpatient_bed_occupancy_7_day_avg = all_adult_hospital_inpatient_bed_occupied_7_day_avg / all_adult_hospital_inpatient_beds_7_day_avg)
  ...
  rgn_cidade_data <- rgn_cidade_data[
    rgn_cidade_data$all_adult_hospital_inpatient_bed_occupied_7_day_avg > 0 &
    rgn_cidade_data$staffed_adult_icu_bed_occupancy_7_day_avg > 0 &
    rgn_cidade_data$previous_day_total_ED_visits_7_day_sum > 0, 
  ]
